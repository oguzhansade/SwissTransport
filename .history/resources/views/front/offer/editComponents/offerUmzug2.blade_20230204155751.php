    ...
    <div class="row p-3">
        ...
        <div class="col-md-6">
            ...
            <div class="mt-2 isKostendach">
                ...
                <input type="checkbox"  name="isKostendach" id="isKostendach" class="js-switch mt-1" data-color="#9c27b0" data-size="small" data-switchery="false"  checked
                @if($umzug && \App\Models\OfferteUmzug::InfoUmzug($umzug,'topCost') == NULL) checked @endif>
            </div>

            <div class="kostendach-area" @if($umzug && \App\Models\OfferteUmzug::InfoUmzug($umzug,'topCost') == 0 ) style="display: none;" @endif >
            ...
            <div class="pauschal-area "  @if($umzug && \App\Models\OfferteUmzug::InfoUmzug($umzug,'fixedPrice') == 0 ) style="display: none;" @endif>
