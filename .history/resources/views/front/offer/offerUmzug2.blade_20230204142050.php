<div class="row p-3">
    ...
    <div class="col-md-6">
        ...
        <div class="mt-2">
            ...
            <input type="checkbox" class="isKostendach" name="isKostendach" id="isKostendach" class="js-switch mt-1" data-color="#9c27b0" data-size="small" data-switchery="false" >
        </div>
