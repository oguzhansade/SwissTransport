...
<div class="row page-title clearfix">
    <div class="page-title-left">
        <h6 class="page-title-heading mr-0 mr-r-5"> Neue Arbeiter Erfassen</h6>
    </div>
    <!-- /.page-title-left -->
                    ...
                    <div class="col-md-12 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                                <form action="{{ route('worker.store') }}" autocomplete="off" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            <label class="col-form-label">Name</label>
                                            <input class="form-control" required name="name" type="text" placeholder="Worker Name">
                                        </div>
                                    
                                        <div class="col-md-6">
                                            <label class="col-form-label">Nachname</label>
                                            <input class="form-control" required name="surname" type="text" placeholder="Worker Surname">
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input class="form-control" type="text" id="phone"  placeholder="Worker Number" name="phone">
                                            <small class="text-primary"><i>Wichtig für Benachrichtigungen</i></small>
                                        </div>

                                        <div class="col-md-12">
                                            <label class="col-form-label" >Preis/Stunde</label>
                                            <input class="form-control" required name="workPrice" type="number" placeholder="[CHF]">
                                        </div>
