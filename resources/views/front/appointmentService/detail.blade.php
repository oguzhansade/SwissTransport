...
<div class="row page-title clearfix">
    <div class="page-title-left">
        <h6 class="page-title-heading mr-0 mr-r-5">Termin Anschauen - Auftragsbestätigung</h6>
    </div>
    <!-- /.page-title-left -->
        ...
        <div class="col-md-12 widget-holder">
            <div class="widget-bg">
                <div class="widget-body clearfix">
                    <p><form id="appService" name="myForm" action="{{ route('appointmentService.update',['id' => $data['id']]) }}"  method="POST" enctype="multipart/form-data"></p>
                       @csrf
...
{{-- Onay Alanı Ayarları --}}
<script>
    $("#appService :input").prop("disabled", true);
    ...
    umzugbutton2.click(function(){
        if($(this).hasClass("checkbox-checked") && $("#isUmzug2").is(':checked'))
        {
