...
<div id="einpack--area" class="rounded einpack--area" style="background-color: #C8DFF3; @if($einpack == NULL) display:none; @endif">
    <div class="row p-3">
        <div class="col-md-6">
            ...
            <input class="form-control" class="date"  name="einpackDate"  type="date" @if($einpack) value="{{ $einpack['einpackDate'] }}" @endif> 

            <div class="row">
                <div class="col-md-6">
                    <label class=" col-form-label" for="l0">Anzahl Std </label>
                    <input id="einpackHours" class="form-control" class="time"  name="einpackHours"  type="number" @if($einpack) value="{{ $einpack['einpackHour'] }}" @endif> 
                    <a onclick="extraAreaEinpack()" class="extraTimeEinpack text-primary" style="cursor: pointer;
                    @if($einpack && $einpack['einpackHour2'] && $einpack['einpackChf2'] ) display: none; @endif">+ Weitere Zeiteingabe</a>
                </div>
    
                <div class="col-md-6">
                    <label class=" col-form-label" for="l0">Ansatz  [CHF]</label>
                    <input class="form-control" class="date"  name="einpackChf"  type="number" 
                    @if($einpack) value="{{ $einpack['einpackChf'] }}" @endif> 
                </div>
            </div>

            <div class="row extraTime-einpack-area" @if($einpack && $einpack['einpackHour2'] == NULL  && $einpack['einpackChf2'] == NULL) style="display: none;" @endif>
                <div class="col-md-6">
                    <label class=" col-form-label" for="l0">Anzahl Std</label>
                    <input class="form-control" class="time"  name="einpackHours2"  type="number" 
                    @if ($einpack)
                    value="{{ $einpack['einpackHour2'] }}"
                    @endif> 
                </div>
    
                <div class="col-md-6">
                    <label class=" col-form-label" for="l0">Ansatz  [CHF]</label>
                    <input class="form-control" class="date"  name="einpackChf2"  type="number" @if($einpack) value="{{ $einpack['einpackChf2']  }}" @endif> 
                </div>
            </div>

            <label class=" col-form-label" for="l0">Anfahrt/Rückfahrt [CHF]</label>
            <input class="form-control" class="date"  name="einpackRoadChf"  type="number" @if($einpack) value="{{ $einpack['einpackRoadChf'] }}" @endif> 
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-7">
                            <div class="checkbox checkbox-rounded checkbox-color-scheme">
                                <label class="checkbox">
                                    <input type="checkbox" name="einpackMasraf" @if ($einpack && $einpack['extra1']) checked @endif> 
                        ...
                        <div class="col-md-5">
                            ...
                            @if ($einpack && $einpack['extra1']) value="{{ $einpack['extra1'] }}" @else value="10" @endif>
                        </div>
                    </div> 
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="checkbox checkbox-rounded checkbox-color-scheme">
                                <label class="checkbox">
                                    <input type="checkbox" name="einpackMasraf1" @if ($einpack && $einpack['extra2']) checked @endif> 
                        ...
                        <div class="col-md-5">
                            ...
                            @if ($einpack && $einpack['extra2']) value="{{ $einpack['extra2'] }}" @else value="0" @endif>
                        </div>
                    </div>  
                    ...
                    <div class="row ">
                        <div class="col-md-7">
                            ...
                            @if ($einpack && $einpack['extraValue1']) value="{{ $einpack['extraText1'] }}" @endif>
                        </div>
                        <div class="col-md-5">
                            <input class="form-control"  name="einpackExtra1Cost" placeholder="0"  type="text"
                            @if ($einpack && $einpack['extraValue1']) value="{{ $einpack['extraValue1'] }}" @else value="0.00" @endif>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-7">
                            ...
                            @if ($einpack && $einpack['extraValue2']) value="{{ $einpack['extraText2'] }}" @endif>
                        </div>
                        <div class="col-md-5">
                            <input class="form-control"  name="einpackExtra2Cost" placeholder="0"  type="text" 
                            @if ($einpack && $einpack['extraValue2']) value="{{ $einpack['extraValue2'] }}" @else value="0.00" @endif>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-6">
            ...
            <label class="col-form-label" for="l0">Rabatt[%]</label>
            <input class="form-control"  name="einpackDiscountPercent" placeholder="0"  type="text" @if($einpack && $einpack['discountPercent']) value="{{ $einpack['discountPercent'] }}" @else value="0.00" @endif> 

            <label class="col-form-label" for="l0">Entgegenkommen</label>
            <input class="form-control"  name="einpackDiscount2" placeholder="0"  type="text" @if($einpack && $einpack['discount2']) value="{{ $einpack['discount2'] }}" @else value="0.00" @endif>
            ...
            <div class="row ">
                <div class="col-md-7">
                    ...
                    @if($einpack && $einpack['extraDiscountValue1']) value="{{ $einpack['extraDiscountText1'] }}" @endif>
                </div>
                <div class="col-md-5">
                    <label class="col-form-label" for="l0">Weitere Abzüge</label>
                    <input class="form-control"  name="einpackExtraDiscount" placeholder="0"  type="text" 
                    @if($einpack && $einpack['extraDiscountValue1']) value="{{ $einpack['extraDiscountValue1'] }}" @else value="0.00" @endif>
                </div>
            </div>
            ...
            <div class="row mt-1">
                <div class="col-md-7">
                    ...
                    @if($einpack && $einpack['extraDiscountValue2']) value="{{ $einpack['extraDiscountText2'] }}" @endif>
                </div>
                <div class="col-md-5">
                    <input class="form-control"  name="einpackExtraDiscount2" placeholder="0"  type="text"  
                    @if($einpack && $einpack['extraDiscountValue2']) value="{{ $einpack['extraDiscountValue2'] }}" @else value="0.00" @endif>
                </div>
            </div>
