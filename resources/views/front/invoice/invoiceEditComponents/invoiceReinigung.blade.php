...
<div class="rounded reinigung--area" style="background-color: #C8DFF3; @if($reinigung == NULL) display:none; @endif">
    <div class="row p-3">
        <div class="col-md-6">
            ...
            @if($reinigung) value="{{ $reinigung['reinigungDate'] }}" @endif> 
            ...
            <div class="row p-1 mt-5 mb-3 rounded" style="background-color: #286090;">
                <div class="col-md-12">
                    ...
                    @if ($reinigung && $reinigung['reinigungRoom']) value="{{ $reinigung['reinigungRoom'] }}" @endif>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    @if ($reinigung && $reinigung['reinigungHours']) value="{{ $reinigung['reinigungHours'] }}" @else value="0" @endif> 
                </div>
    
                <div class="col-md-6">
                    <label class=" col-form-label" for="l0">Ansatz  [CHF]</label>
                    <input class="form-control" class="date"  name="reinigungChf"  type="number" 
                    @if ($reinigung && $reinigung['reinigungChf']) value="{{ $reinigung['reinigungChf'] }}" @else value="0" @endif> 
                </div>
            </div>
                ...
                <div class="form-group">
                    ...
                    <div class="row ">
                        <div class="col-md-7">
                            ...
                            @if ($reinigung && $reinigung['extraValue1']) value="{{ $reinigung['extraText1'] }}" @endif>
                        </div>
                        <div class="col-md-5">
                            <input class="form-control"  name="reinigungExtra1Cost" placeholder="0"  type="text" 
                            @if ($reinigung && $reinigung['extraValue1']) value="{{ $reinigung['extraValue1'] }}" @else value="0.00" @endif>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-7">
                            ...
                            @if ($reinigung && $reinigung['extraValue2']) value="{{ $reinigung['extraText2'] }}" @endif>
                        </div>
                        <div class="col-md-5">
                            <input class="form-control"  name="reinigungExtra2Cost" placeholder="0"  type="text" 
                            @if ($reinigung && $reinigung['extraValue2']) value="{{ $reinigung['extraValue2'] }}" @else value="0.00" @endif>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-6">
            ...
            <input class="form-control"  name="reinigungDiscount" placeholder="0"  type="text" 
            @if($reinigung && $reinigung['discount']) value="{{ $reinigung['discount'] }}" @else value="0.00" @endif> 

            <label class="col-form-label" for="l0">Rabatt[%]</label>
            <input class="form-control"  name="reinigungDiscountPercent" placeholder="0"  type="text" 
            @if($reinigung && $reinigung['discountPercent']) value="{{ $reinigung['discountPercent'] }}" @else value="0.00" @endif> 

            <label class="col-form-label" for="l0">Entgegenkommen</label>
            <input class="form-control"  name="reinigungDiscount2" placeholder="0"  type="text" 
            @if($reinigung && $reinigung['discount2']) value="{{ $reinigung['discount2'] }}" @else value="0.00" @endif>
            ...
            <div class="row ">
                <div class="col-md-7">
                    ...
                    @if($reinigung && $reinigung['extraDiscountValue1']) value="{{ $reinigung['extraDiscountText1'] }}" @endif>
                </div>
                <div class="col-md-5">
                    <label class="col-form-label" for="l0">Weitere Abzüge</label>
                    <input class="form-control"  name="reinigungExtraDiscount" placeholder="0"  type="text" 
                    @if($reinigung && $reinigung['extraDiscountValue1']) value="{{ $reinigung['extraDiscountValue1'] }}" @else value="0.00" @endif>
                </div>
            </div>
            ...
            <div class="row mt-1">
                <div class="col-md-7">
                    ...
                    @if($reinigung && $reinigung['extraDiscountValue2']) value="{{ $reinigung['extraDiscountText2'] }}" @endif>
                </div>
                <div class="col-md-5">
                    <input class="form-control"  name="reinigungExtraDiscount2" placeholder="0"  type="text"  
                    @if($reinigung && $reinigung['extraDiscountValue2']) value="{{ $reinigung['extraDiscountValue2'] }}" @else value="0.00" @endif>
                </div>
            </div>
            ...
            @if($reinigung && $reinigung['reinigungCost']) value="{{ $reinigung['reinigungCost'] }}" @else value="0.00" @endif> 

            <label class="col-form-label mt-5" for="l0">Schadenzahlung</label>
            <input class="form-control"  name="reinigungPaid1" placeholder="0"  type="text" style="background-color: #286090;color:white;" 
            @if($reinigung && $reinigung['reinigungPaid1']) value="{{ $reinigung['reinigungPaid1'] }}" @else value="0.00" @endif>

            <label class="col-form-label" for="l0">Anzahlung</label>
            <input class="form-control"  name="reinigungPaid2" placeholder="0"  type="text" style="background-color: #286090;color:white;" 
            @if($reinigung && $reinigung['reinigungPaid2']) value="{{ $reinigung['reinigungPaid2'] }}" @else value="0.00" @endif>

            <label class="col-form-label" for="l0">Bar Bezahlt</label>
            <input class="form-control"  name="reinigungPaid3" placeholder="0"  type="text" style="background-color: #286090;color:white;" 
            @if($reinigung && $reinigung['reinigungPaid3']) value="{{ $reinigung['reinigungPaid3'] }}" @else value="0.00" @endif>
            ...
            @if($reinigung && $reinigung['reinigungTotalPrice']) value="{{ $reinigung['reinigungTotalPrice'] }}" @else value="0.00" @endif>
        </div>
    </div>
</div>
