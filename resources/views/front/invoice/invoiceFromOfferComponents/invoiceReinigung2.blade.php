        ...
        <div class="col-md-6">
            ...
            <div class="row p-1 mt-5 mb-3 rounded" style="background-color: #8778AA;">
                <div class="col-md-12">
                    ...
                    <input class="form-control" class="reinigung2FixedRoom"  name="reinigung2FixedRoom"  type="text" value="0">
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    @if ($reinigung2 && $reinigung2['hours']) value="{{ $reinigung2['hours'] }}" @else value="0" @endif> 
                </div>
