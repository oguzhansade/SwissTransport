...
<div class="rounded entsorgung--area" style="background-color: #C8DFF3; @if($entsorgung == NULL) display:none; @endif">
    <div class="row p-3">
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            ...
            <input class="form-control"  name="entsorgungPaid1" placeholder="0"  type="text" style="background-color: #286090;color:white;" 
            ...
            <input class="form-control"  name="entsorgungPaid2" placeholder="0"  type="text" style="background-color: #286090;color:white;" 
