...
<div class="row page-title clearfix">
    <div class="page-title-left">
        <h6 class="page-title-heading mr-0 mr-r-5"> Edit Reinigung</h6>
    </div>
    <!-- /.page-title-left -->
        ...
        <div class="col-md-12 widget-holder task-area">
            <div class="widget-bg">
                <div class="widget-body clearfix">
                    <form action="{{ route('expense.updateReinigung',['id' => $data['id']]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-actions">
                            <div class="form-group row">
                                ...
                                <div class="col-md-12 ml-md-auto btn-list">
                                    <a id="createTask" href="{{ route('expense.deleteReinigung',['id' => $data['id']]) }}"
