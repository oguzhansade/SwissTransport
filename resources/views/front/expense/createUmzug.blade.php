...
<script>
    ...
    $("#addRowBtn").click(function () {
        ...
        '<td><select class="m-b-10 form-control isci" name="islem['+i+'][expense]" data-toggle="select2">'+
        ...
        //value="' + defaultHour + '"
        newRow+='</select></td>'+
        '<td><input type="text" class="form-control" id="tutar" name="islem['+i+'][expenseValue]" value="0" ></td>'+
