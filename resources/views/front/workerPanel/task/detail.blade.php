...
<style>
    ...
    border: 1px groove #8154e200 !important;
    border-radius: 10px;
    color: #8254E2;
...
<div class="row d-flex p-0 justify-content-between" >
    ...
    <div class="widget-list shadow rounded" >
                        ...
                        <div class="widget-body clearfix">
                            <div class="col-md-12" >
                                <div class="row p-3" >
                                    {{-- İşçi Bilgileri --}}
                                    <div class="col">
                                        <fieldset class="scheduler-border pb-0">
                                            <legend>
                                                <img src="{{ asset('assets/demo/white-arbeiter-icon.png') }}" class="img-fluid notify-badge p-1" alt="..." width="75"> 
                                                <span class="custom-scheduler-border b-shadow ">Arbeiter Details</span>
                                            </legend>
                                    ...
                                    {{-- Müşteri Bilgileri --}}
                                    <div class="col custom-height">
                                        <fieldset class="scheduler-border">
                                            <legend >
                                                <img src="{{ asset('assets/demo/white-arbeiter-icon.png') }}" class="img-fluid notify-badge p-1" alt="..." width="75">
                                                <span class="custom-scheduler-border b-shadow ">Kunden Details</span>
                                            </legend>
                                            <table class="table-sm">
                                                <tr>
                                    ...
                                    <div class="col custom-height">
                                        <fieldset class="scheduler-border">
                                            <legend>
                                                <img src="{{ asset('assets/demo/white-arbeiter-icon.png') }}" class="img-fluid notify-badge p-1" alt="..." width="75"> 
                                                <span class="custom-scheduler-border b-shadow ">Service Details</span>
                                            </legend>
                                            <table class="table-sm">
                                                <tr>
                                                    <td valign="top">
                                    ...
                                    <div class="col custom-height">
                                        <fieldset class="scheduler-border">
                                            <legend>
                                                <img src="{{ asset('assets/demo/white-arbeiter-icon.png') }}" class="img-fluid notify-badge p-1" alt="..." width="75"> 
                                                <span class="custom-scheduler-border b-shadow ">Team Details</span>
                                            </legend>
                                            <table class="table-sm">
                                                @foreach ($team as $worker)
                                                <tr>
                                                    <td><span class="h6"><img src="{{ asset('assets/demo/arbeiter-icon.png') }}" class="img-fluid p-1" alt="..." width="35"></span></td>
                                                    <td style="padding-top: 14px;"> <span class="h6">{{ $worker['workerName'] }}</span></td>
                                                </tr> 
                                                @endforeach
                                ...
                                @if($ausAdres1 || $einAdres1)
                                    ...
                                    <div class="address-area-1" style="display: none;">
                                        <div class="row p-3">
                                            ...
                                            <div class="col">
                                                <fieldset class="scheduler-border">
                                                    <legend class="scheduler-border b-shadow">Auszug Address</legend>
                                                    <table class="table-sm">
                                                        <tr>
                                            ...
                                            <div class="col">
                                                <fieldset class="scheduler-border">
                                                    <legend class="scheduler-border b-shadow">Einzug Address</legend>
                                                    <table class="table-sm">
                                                        <tr>
                                                            <td><span class="h6 ">Strasse: </span></td>
                                ...
                                @if($ausAdres2 || $einAdres2)
                                    ...
                                    <div class="address-area-2" style="display: none;">
                                        <div class="row p-3">
                                            ...
                                            <div class="col">
                                                <fieldset class="scheduler-border">
                                                    <legend class="scheduler-border b-shadow">Auszug Address 2</legend>
                                                    <table class="table-sm">
                                                        <tr>
                                                            <td><span class="h6 ">Strasse: </span></td>
                                            ...
                                            <div class="col">
                                                <fieldset class="scheduler-border">
                                                    <legend class="scheduler-border b-shadow">Einzug Address 2</legend>
                                                    <table class="table-sm">
                                                        <tr>
                                                            <td><span class="h6 ">Strasse: </span></td>
                                ...
                                @if($ausAdres3 || $einAdres3)
                                    ...
                                    <div class="address-area-3" style="display: none;">
                                        <div class="row p-3">
                                            ...
                                            <div class="col">
                                                <fieldset class="scheduler-border">
                                                    <legend class="scheduler-border b-shadow">Auszug Address 3</legend>
                                                    <table class="table-sm">
                                                        <tr>
                                                            <td><span class="h6 ">Strasse: </span></td>
                                            ...
                                            <div class="col">
                                                <fieldset class="scheduler-border">
                                                    <legend class="scheduler-border b-shadow">Einzug Address 3</legend>
                                                    <table class="table-sm">
                                                        <tr>
                                                            <td><span class="h6 ">Strasse: </span></td>
