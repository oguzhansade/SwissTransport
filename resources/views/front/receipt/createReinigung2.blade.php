                    ...
                    <form action="{{ route('receiptReinigung.storeReinigung',['id' => $offer['id'],'customer' => $data['id']]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div id="makbuzAlanı" >
                                ...
                                <div class="form-group row p-3" style="background-color:#c3a7f5;">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        @if ($offer['offerteReinigung2Id']) value="{{ \App\Models\OfferteReinigung::InfoReinigung($offer['offerteReinigung2Id'],'startDate') }}" @endif>
                                        <input class="form-control mt-1" name="reinigungStartTime"  type="time"
                                        @if ($offer['offerteReinigung2Id']) value="{{ \App\Models\OfferteReinigung::InfoReinigung($offer['offerteReinigung2Id'],'startTime') }}" @endif>
                                    </div>
                                    <div class="col-md-3">
                                        <b class="text-dark">Abgabetermin</b>
                                        <input class="form-control" name="reinigungEndDate"  type="date"
                                        @if ($offer['offerteReinigung2Id']) value="{{ \App\Models\OfferteReinigung::InfoReinigung($offer['offerteReinigung2Id'],'endDate') }}" @endif>
                                        <input class="form-control mt-1" name="reinigungEndTime"  type="time"
                                        @if ($offer['offerteReinigung2Id']) value="{{ \App\Models\OfferteReinigung::InfoReinigung($offer['offerteReinigung2Id'],'endTime') }}" @endif>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="harcamaAlanı" class="border-bottom border-primary">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-7">
                                        ...
                                        @if ($offer['offerteReinigung2Id']) value="{{ \App\Models\OfferteReinigung::InfoReinigung($offer['offerteReinigung2Id'],'reinigungType') }}" @endif>
                                    </div>
                                    <div class="col-md-5">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        ...
                                        @if ($offer['offerteReinigung2Id']) value="{{ \App\Models\OfferteReinigung::InfoReinigung($offer['offerteReinigung2Id'],'extraReinigung') }}" @endif>
                                    </div>
                                </div>
                            ...
                            <div id="ekucretAlanı" class="mt-3">
                                ...
                                @if ($offer['offerteReinigung2Id'] && \App\Models\OfferteReinigung::InfoReinigung($offer['offerteReinigung2Id'],'extra1'))
                                    <div class="form-group row">
                                        <div class="col-md-7">
                                        ...
                                        <div class="col-md-5">
                                            <input class="form-control ek" name="addCost1" placeholder="[CHF]"  type="text"
                                             value="{{ \App\Models\OfferteReinigung::InfoReinigung($offer['offerteReinigung2Id'],'extra1') }}">
                                        </div>
                                    </div>
                                @endif

                                @if ($offer['offerteReinigung2Id'] && \App\Models\OfferteReinigung::InfoReinigung($offer['offerteReinigung2Id'],'extra2'))
                                    <div class="form-group row">
                                        <div class="col-md-7">
                                        ...
                                        <div class="col-md-5">
                                            <input class="form-control ek" name="addCost2" placeholder="[CHF]"  type="text"
                                             value="{{ \App\Models\OfferteReinigung::InfoReinigung($offer['offerteReinigung2Id'],'extra2') }}">
                                        </div>
                                    </div>
                                @endif

                                @if ($offer['offerteReinigung2Id'] && \App\Models\OfferteReinigung::InfoReinigung($offer['offerteReinigung2Id'],'extra3'))
                                    <div class="form-group row">
                                        <div class="col-md-7">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            value="{{ \App\Models\OfferteReinigung::InfoReinigung($offer['offerteReinigung2Id'],'extra3') }}" >
                                        </div>
                                    </div>
                                @endif


                                @if ($offer['offerteReinigung2Id'] && \App\Models\OfferteReinigung::InfoReinigung($offer['offerteReinigung2Id'],'extraCostValue1'))
                                    <div class="form-group row">
                                        <div class="col-md-7">
                                            <input class="form-control" name="addCost4Text" placeholder="Text"  type="text"
                                            value="{{ \App\Models\OfferteReinigung::InfoReinigung($offer['offerteReinigung2Id'],'extraCostText1') }}">
                                        </div>
                                        <div class="col-md-5">
                                            <input class="form-control ek" name="addCost4" placeholder="[CHF]"  type="text"
                                            value="{{ \App\Models\OfferteReinigung::InfoReinigung($offer['offerteReinigung2Id'],'extraCostValue1') }}">
                                        </div>
                                    </div>
                                @endif

                                @if ($offer['offerteReinigung2Id'] && \App\Models\OfferteReinigung::InfoReinigung($offer['offerteReinigung2Id'],'extraCostValue2'))
                                    <div class="form-group row">
                                        <div class="col-md-7">
                                            <input class="form-control" name="addCost5Text" placeholder="Text"  type="text"
                                            value="{{ \App\Models\OfferteReinigung::InfoReinigung($offer['offerteReinigung2Id'],'extraCostText2') }}" >
                                        </div>
                                        <div class="col-md-5">
                                            <input class="form-control ek" name="addCost5" placeholder="[CHF]"  type="text"
                                            value="{{ \App\Models\OfferteReinigung::InfoReinigung($offer['offerteReinigung2Id'],'extraCostValue2') }}">
                                        </div>
                                    </div>
                                @endif
                            ...
                            <div id="kesintiAlanı" class="mt-3">
                                ...
                                @if ($offer['offerteReinigung2Id'] && \App\Models\OfferteReinigung::InfoReinigung($offer['offerteReinigung2Id'],'discount'))
                                    <div class="form-group row">
                                        <div class="col-md-7">
                                            <input class="form-control" name="addDiscount1Text" placeholder="Text"  type="text"
                                            value="{{ \App\Models\OfferteReinigung::InfoReinigung($offer['offerteReinigung2Id'],'discountText') }}" >
                                        </div>
                                        <div class="col-md-5">
                                            <input class="form-control ekc" name="addDiscount1" placeholder="[CHF]"  type="text"
                                             value="{{ \App\Models\OfferteReinigung::InfoReinigung($offer['offerteReinigung2Id'],'discount') }}">
                                        </div>
                                    </div>
                                @endif
