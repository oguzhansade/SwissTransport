...
<div class="row page-title clearfix">
    <div class="page-title-left">
        <h6 class="page-title-heading mr-0 mr-r-5">Neue Tarif Erfassen</h6>
    </div>
    <!-- /.page-title-left -->
                        ...
                        @csrf
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" name="tariffDescription"  type="text" required>                                
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col">
                                    ...
                                    <input class="form-control"  name="ma"   type="number"  required value="0">                                
                                </div>

                                <div class="col">
                                    <label class=" col-form-label" for="l0">LKW</label>
                                    <input class="form-control"  name="lkw"   type="number"  required value="0">                                
                                </div>

                                <div class="col">
                                    <label class=" col-form-label" for="l0">ANHANGER</label>
                                    <input class="form-control"  name="anhanger"   type="number"  required value="0">                                
                                </div>

                                <div class="col">
                                    <label class=" col-form-label" for="l0">CHF</label>
                                    <input class="form-control"  name="chf"  type="number"  required value="0">                                
                                </div>
                            </div>
