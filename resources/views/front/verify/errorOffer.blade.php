...
<body>
    ...
    <div class="mt-1">
        <div class="container bg-white m-auto b-shadow  rounded-custom p-5">
            <h1 class="text-primary text-center "><i class="feather feather-x-circle" ></i></h1><br>
            <h3 class="text-primary text-center " style="margin-top:-15px;">Beim Bestätigen Ihres Angebots ist ein Fehler aufgetreten. Bitte versuchen Sie es später erneut.</h3>
        </div>
    </div>
