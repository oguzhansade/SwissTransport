    ...
    <div class="row p-3">
        <div class="col-md-6">
            ...
            <div class="row  rounded" >
                ...
                @if($entsorgung && \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'fixedCost') != NULL) 
                    value="{{ \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'fixedCost') }}"
                @endif>
            </div>
            ...
            <div class="row  rounded" >
                ...
                @if($entsorgung && \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'m3') != NULL) 
                    value="{{ \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'m3') }}"
                @endif>
            </div>
            ...
            @if($entsorgung && \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'tariff') == NULL)  style="display: none;" @endif>
                <div class="col">
                    ...
                    @if($entsorgung && \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'ma') != NULL) 
                        value="{{ \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'ma') }}"
                    @endif>                                
                </div>
                <div class="col">
                    <label class=" col-form-label" for="l0">LKW</label>
                    <input class="form-control"  name="entsorgunglkw" placeholder="0"  type="number" 
                    @if($entsorgung && \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'lkw') != NULL) 
                        value="{{ \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'lkw') }}"
                    @endif>                                
                </div>
                <div class="col">
                    ...
                    @if($entsorgung && \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'anhanger') != NULL) 
                        value="{{ \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'anhanger') }}"
                        @else value="{{ 0 }}"
                    @endif>                                
                </div>
                <div class="col">
                    ...
                    @if($entsorgung && \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'chf') != NULL) 
                        value="{{ \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'chf') }}"
                    @endif>                                
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    @if($entsorgung && \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'hour') != NULL) 
                        value="{{ \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'hour') }}"
                    @endif>                                
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    @if($entsorgung && \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'entsorgungDate') != NULL) 
                        value="{{ \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'entsorgungDate') }}"
                    @endif>                                
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    @if($entsorgung && \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'entsorgungTime') != NULL) 
                        value="{{ \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'entsorgungTime') }}"
                    @endif>                                
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    @if($entsorgung && \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'arrivalReturn') != NULL) 
                        value="{{ \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'arrivalReturn') }}"
                        @else value="{{ 0 }}"
                    @endif>                                
                </div>
            </div>
        ...
        <div class="col-md-6">
            <div class="extra-cost-entsorgung mt-1">
                ...
                @if($entsorgung
                    ...
                    && \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'extraCostValue1') == NULL
                    && \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'extraCostValue2') == NULL
                    ) 
                    unchecked
                    @else checked
                @endif>  
                ...
                <div class="form-group">
                    ...
                    <div class="row ">
                        <div class="col-md-7">
                            ...
                            @if($entsorgung && \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'extraCostText1') != NULL) 
                                value="{{ \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'extraCostText1') }}"
                            @endif>
                        </div>
                        <div class="col-md-5">
                            <input class="form-control"  name="entsorgungCost1" placeholder="0"  type="number" 
                            @if($entsorgung && \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'extraCostValue1') != NULL) 
                                value="{{ \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'extraCostValue1') }}"
                                @else value="{{ 0 }}"
                            @endif>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-7">
                            ...
                            @if($entsorgung && \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'extraCostText2') != NULL) 
                                value="{{ \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'extraCostText2') }}"
                            @endif>
                        </div>
                        <div class="col-md-5">
                            <input class="form-control"  name="entsorgungCost2" placeholder="0"  type="number" 
                            @if($entsorgung && \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'extraCostValue2') != NULL) 
                                value="{{ \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'extraCostValue2') }}"
                                @else value="{{ 0 }}"
                            @endif>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    @if($entsorgung && \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'discount') != NULL) 
                        value="{{ \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'discount') }}"
                        @else value="{{ 0 }}"
                    @endif>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    @if($entsorgung && \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'discountPercent') != NULL) 
                        value="{{ \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'discountPercent') }}"
                        @else value="{{ 0 }}"
                    @endif>
                </div>
            </div>
            ...
            <div class="row ">
                <div class="col-md-7">
                    ...
                    @if($entsorgung && \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'extraDiscountText') != NULL) 
                        value="{{ \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'extraDiscountText') }}"
                    @endif>
                </div>
                <div class="col-md-5">
                    <label class="col-form-label" for="l0">Weitere Abzüge</label>
                    <input class="form-control"  name="entsorgungExtraDiscount" placeholder="0"  type="number" 
                    @if($entsorgung && \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'extraDiscountPrice') != NULL) 
                        value="{{ \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'extraDiscountPrice') }}"
                        @else value="{{ 0 }}"
                    @endif>
                </div>
            </div>
            ...
            @if($entsorgung && \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'defaultPrice') != NULL) 
                value="{{ \App\Models\OfferteEntsorgung::InfoEntsorgung($entsorgung,'defaultPrice') }}"
                @else value="{{ 0 }}"
            @endif>
...
<script>       
    ...
    function isRequiredEntsorgung()
    {
        ...
        $("input[name=estimatedVolume]").prop('required',true);   
    ...
    function isNotRequiredEntsorgung()
    {
        ...
        $("input[name=estimatedVolume]").prop('required',false);   
