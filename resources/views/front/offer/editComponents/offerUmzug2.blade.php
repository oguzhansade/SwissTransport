        ...
        <div class="col-md-6">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <input class="form-control" class="date"  name="umzugArrivalGas"  type="number"
                    @if($umzug && \App\Models\OfferteUmzug::InfoUmzug($umzug,'arrivalGas'))
                        value="{{ \App\Models\OfferteUmzug::InfoUmzug($umzug,'arrivalGas') }}"
                        @else value="0"
                    @endif>
                </div>
                <div class="col">
                    <label class=" col-form-label" for="l0">Rückfahrt [CHF]</label>
                    <input class="form-control" class="date"  name="umzugReturnGas"  type="number"
                    @if($umzug && \App\Models\OfferteUmzug::InfoUmzug($umzug,'returnGas'))
                        value="{{ \App\Models\OfferteUmzug::InfoUmzug($umzug,'returnGas') }}"
                        @else value="0"
                    @endif>
                </div>
            </div>
