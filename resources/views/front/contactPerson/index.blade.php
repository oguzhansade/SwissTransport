...
@section('content')
 ...
 <div class="row page-title clearfix">
    <div class="page-title-left">
        <h6 class="page-title-heading mr-0 mr-r-5">ContactPerson</h6>
    </div>
    <!-- /.page-title-left -->
    <div class="page-title-right d-none d-sm-inline-flex">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">ContactPerson</li>
        </ol>
        ...
        <div class="col-md-12 widget-holder">
            <div class="widget-bg">
                <div class="widget-heading clearfix">
                    <h5>ContactPersonliste</h5>
                </div>
                <!-- /.widget-heading -->
                <div class="widget-body clearfix">
                    <table id="contactPerson" class="table table-striped table-responsive">
                        <thead>
                            <tr class="text-dark">
                                <th>Name</th>
                                <th>Nachname</th>
...
<script>
    $(document).ready(function() {
        ...
        let table =  $('#contactPerson').DataTable( {
