...
<div class="row page-title clearfix">
    <div class="page-title-left">
        <h6 class="page-title-heading mr-0 mr-r-5"> Neue Contact Person</h6>
    </div>
    <!-- /.page-title-left -->
                    ...
                    <div class="col-md-12 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                                <form action="{{ route('contactPerson.store') }}" autocomplete="off" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            <label class="col-form-label">Name</label>
                                            <input class="form-control" required name="name" type="text" placeholder=" Name" required>
                                        </div>
                                    
                                        <div class="col-md-6">
                                            <label class="col-form-label">Nachname</label>
                                            <input class="form-control" required name="surname" type="text" placeholder=" Surname" required>
                                        </div>

                                        <div class="col-md-6">
                                            <label class="col-form-label" >E-mail</label>
                                            <input class="form-control" required name="email" type="email" placeholder="people@example.com" required>
                                        </div>

                                        <div class="col-md-6">
                                            <label class="col-form-label">Position</label>
                                            <input class="form-control" required name="duty" type="text" placeholder="Duty Information"  required>
                                        </div>
