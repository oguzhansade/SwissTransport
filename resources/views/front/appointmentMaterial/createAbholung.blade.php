...
<div class="row page-title clearfix">
    <div class="page-title-left">
        <h6 class="page-title-heading mr-0 mr-r-5">Termine Erstellen - Lieferung(Abholung)</h6>
    </div>
    <!-- /.page-title-left -->
    ...
    <div class="row">
        <div class="col-md-12">
            <strong class="h5 mr-1"> <b>Kunde:</b> </strong> <span class="h5 text-primary ">
                {{ App\Models\Customer::getPublicName($data['customerId']) }} {{ $data['id'] }}</span>
        </div>
        <div class="col-md-12 widget-holder">
            <div class="widget-bg">
                <div class="widget-body clearfix">
                    <p><form id="myform" name="myForm" action="{{ route('appointmentMaterial.storeAbholung',['lieferungId' => $data['id']]) }}"  method="POST" enctype="multipart/form-data"></p>
                       @csrf
                        <div class="deliverable--area">
                            ...
                            <div class="form-group row deliveryType--area" @if ($data['deliverable'] == 1) style="display: none;" @endif>
                                <div class="col-md-12">
                                    ...
                                    <div class="radiobox">
                                        <label>
                                            <input type="radio" class="deliveryType"  name="deliveryType" value="1" checked> <span class="label-text">Abholung</span>
                                        </label>
                                    </div>
                                </div>
                            </div>
